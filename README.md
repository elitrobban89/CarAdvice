...
- Budget-slider med tickmärken och live-uppdaterat värde:
  ...
  - **"⚡ X kr räcker till:"** — kurerad ruta under reglaget som säger vad budgeten köper på begagnatmarknaden (`CA_EV_BUDGET_LEVELS`). Visas bara för kategorin elbil: samma 150 000 kr köper en helt annan bensinbil. Ommätt 2026-08-08 mot **samma underlag som prisraden på korten** — högst 10 000 mil och medianrelativ outlier-trimning — annars lovar rutan en bil som bara finns som utsliten. Texterna låg då en nivå efter marknaden: "MG ZS EV kring 100 000 kr" var 129 900, ID.3 stod kvar på 299 000-nivån trots att den börjar vid 198 900, och Polestar 2/ID.4/Enyaq sades "börja bli möjliga" först vid 399 000 fast de går att köpa för 209 000/229 500/279 000. Siffrorna åldras — mät om med Blockets API (gratis, ingen Groq-kvot): `sales_form=1&2`, `mileage_to=10000`, `sort=PRICE_ASC`, utan årsfilter
