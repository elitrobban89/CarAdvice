...
- **"Motor & batterialternativ" är verifierat mot `ev_spec`, inte AI-text** (`verifiedEngineOptions`): alla matchande varianter hämtas, batterier inom 8 % slås ihop till ett räckviddsspann (netto/brutto för samma fysiska batteri), och **trimnamnet hängs på när gruppen är en enda variant** — MG4 gen 1 blir "51 kWh (350 km) · Standard Range, 64 kWh (450 km) · Long Range, 77 kWh (520 km) · Extended Range". En hopslagen grupp lämnas omärkt: den beskriver per definition flera varianter, och ett godtyckligt utvalt namn hade pekat ut fel bil
