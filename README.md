...
- Budget-slider med tickmärken och live-uppdaterat värde:
  ...
  - **"⚡ X kr räcker till:"** — kurerad ruta under reglaget som säger vad budgeten köper på begagnatmarknaden (`CA_BUDGET_LEVELS`). Finns för **alla sex kategorier** — ekonomibil 💰, småbil 🚘, elbil ⚡, familjebil 🚗, laddhybrid 🔌 och SUV 🚙 — med egna nivåer per kategori av nödvändighet: samma 150 000 kr köper en helt annan bil i varje. Nyckeln måste matcha `option`-värdet i snippeten exakt (småbil heter `smaabil`). Ekonomibil och småbil är de enda kategorierna där budgeten kan gå **förbi** segmentet: en fabriksny Kia Picanto kostar ca 150 000 kr, så 400 000 köper inte en bättre småbil utan bara fel bil — toppnivåerna pekar därför vidare till en annan kategori i stället för att hitta på en dyrare modell. Laddhybrid mäts på `fuel`-fältet (`Plug-in Bensin`/`Plug-in Diesel`), annars blandar fritextsökningen på modellnamnet in bensin- och dieselvarianterna, och kategorin har ett tydligt golv: under ca 160 000 kr finns nästan inga annonser med låg mätarställning, vilket den lägsta nivån säger rakt ut i stället för att lova en bil som inte finns. Leasing är undantaget överallt, där är budgeten kr/mån medan nivåerna är köppriser. Mätta 2026-08-08 mot **samma underlag som prisraden på korten** — högst 10 000 mil och medianrelativ outlier-trimning — annars lovar rutan en bil som bara finns som utsliten. Elbilstexterna låg då en nivå efter marknaden: "MG ZS EV kring 100 000 kr" var 129 900, ID.3 stod kvar på 299 000-nivån trots att den börjar vid 198 900, och Polestar 2/ID.4/Enyaq sades "börja bli möjliga" först vid 399 000 fast de går att köpa för 209 000/229 500/279 000. Siffrorna åldras — mät om med Blockets API (gratis, ingen Groq-kvot): `sales_form=1&2`, `mileage_to=10000`, `sort=PRICE_ASC`, och **årsfönster per modell** (`year_from`/`year_to`, ±1). Utan årsfönster matchar fritextsökningen fel bilar och ger orimliga golv — en Škoda Octavia 2025 för 75 600 kr och en "Volvo V90 från 2013", en modell som inte fanns då
...
- **Årsmodellen läses med eller utan parentes** (`CarTitle`): prompten ber om "Märke Modell (år)" och koden litade på det — sexton parsers i åtta klasser matchade bara parentesformen. AI:n skriver ibland "Volkswagen ID.4 2026" i stället, och då föll allt som hänger på årtalet samtidigt: Blockets årsfilter, dedupen, nyprisuppslaget och leasingmatchningen. Live 2026-08-07 fick en ID.4 därför hela modellens annonsspann (3 995–7 961 kr/mån) och missade sitt officiella leasingpris. Ett **bart** årtal måste vara 2010 eller senare, annars äter regeln modellnamn — Peugeot 2008 och BMW 2002 är bilar, inte årsmodeller (3008 och 5008 skyddas redan av att årtal börjar på 19 eller 20)
