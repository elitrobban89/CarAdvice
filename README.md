...
- **YouTube-betyg per bilråd:** under videoraden visas 👍 Bra / ⚖️ Blandat / 👎 Dåligt utifrån vad kommentarerna under recensionen säger om **bilen** — beröm av kanalen eller filmningen räknas inte. Rutan innehåller antalet kommentarer domen bygger på och en mening om vad de lyfter ("flera vittnar om mjukvarustrul men berömmer stolarna"). Under 12 bilrelaterade kommentarer visas ingen ruta alls: kommentarsfält är inget representativt ägarurval, och ett betyg på tunt underlag är sämre än inget betyg
