...
public class DataLoader implements CommandLineRunner {
    ...
    private void seedInsights() {
        expertRepo.saveAll(List.of(
            new ExpertInsight("Bilexpert", null, null, "elbil", null,
            ...
            new ExpertInsight("Bilexpert", "Tesla", "Model 3", "elbil", null,
            ...
            new ExpertInsight("Bilexpert", "Volvo", "XC40 Recharge", "elbil", "suv",
            ...
            new ExpertInsight("Bilexpert", "Toyota", "RAV4 PHEV", "laddhybrid", "suv",
            ...
            new ExpertInsight("Bilexpert", null, null, null, "suv",
            ...
            new ExpertInsight("Bilexpert", null, null, "hybrid", null,
            ...
            new ExpertInsight("Bilexpert", null, null, "bensin", null,
    ...
    private void seedCargoSpecs() {
        ...
        Object[][] data = {
            ...
            { "Seat Arona",              400,  1280 },
            // === Tillagda: saknade i frikomp-listan ===
            { "Audi Q2",                 355,  1050 },
            { "Audi A6",                 530,  1680 },
            { "BMW 1-serie",             380,  1200 },
            { "BMW X1",                  540,  1600 },
            { "Dacia Duster",            472,  1623 },
            { "Dacia Jogger",            708,  1819 },
            { "Honda Civic",             410,  1267 },
            { "Honda Jazz",              304,  1205 },
            { "Hyundai i20",             352,  1165 },
            { "Hyundai i30",             395,  1301 },
            { "Hyundai Santa Fe",        571,  1652 },
            { "Kia Ceed",                395,  1301 },
            { "Kia Picanto",             255,  1010 },
            { "Kia Rio",                 325,  1155 },
            { "Kia Stonic",              352,  1165 },
            { "Kia Niro",                475,  1447 },
            { "Mazda2",                  280,   950 },
            ...
            { "Mazda MX-5",              127,     0 },
            { "Mini Cooper",             211,   731 },
            { "Mini Countryman",         450,  1390 },
            { "Opel Astra",              422,  1250 },
            { "Opel Corsa",              309,  1118 },
            { "Opel Grandland",          514,  1645 },
            { "Opel Mokka-e",            310,  1060 },
            { "Peugeot 208",             311,  1106 },
            { "Peugeot 2008",            434,  1467 },
            { "Peugeot e-208",           265,  1050 },
            { "Peugeot e-2008",          434,  1467 },
            { "Renault Arkana",          513,  1274 },
            { "Seat Ateca",              510,  1505 },
            { "Seat Ibiza",              355,  1165 },
            ...
            { "Subaru Forester",         520,  1779 },
            { "Subaru Outback",          522,  1848 },
            { "Subaru XV",               385,  1270 },
            { "Suzuki Jimny",             85,   377 },
            { "Suzuki Swift",            265,   947 },
            { "Suzuki Vitara",           375,  1281 },
            { "Toyota Aygo X",           231,   829 },
            { "Toyota Yaris Cross",      397,  1190 },
            { "Toyota Hilux",            535,     0 },
            { "Toyota Land Cruiser",     500,  1478 },
            { "Toyota Corolla PHEV",     361,  1354 },
            { "Volkswagen Arteon",       563,  1632 },
            { "Volkswagen T-Cross",      385,  1281 },
            { "Volvo S60",               442,     0 },
            { "Volvo S60 Recharge",      442,     0 },
            { "Volvo XC40",              460,  1336 },
            { "Volvo V40",               335,     0 },
            { "Renault Captur",          422,  1235 },
            { "Mercedes A-Klass",        370,  1200 },
            { "Mercedes GLA",            421,  1235 },
            { "MG HS",                   448,  1556 },
            { "MG ZS",                   448,  1166 },
            { "Nissan Qashqai",          504,  1585 },
            { "Ford Fiesta",             292,  1093 },
            { "Ford Puma",               456,  1216 },
        };
