  ...
  function injectStyles() {
    ...
    css.textContent = [
      ...
      '@media (max-width:520px){',
        // Tio rader i stallet for atta: utan den har atstramningen hamnade '% laddat'
        // 14 px under fold pa en 844 px hog telefon (uppmatt, inte gissat).
        '.ev-splash{justify-content:flex-start;padding:26px 12px 14px;}',
        '.ev-sp-card{padding:20px 15px 16px;border-radius:22px;}',
        '.ev-sp-title{font-size:1.2rem;}',
        '.ev-sp-core{width:66px;height:66px;margin-bottom:9px;}',
        '.ev-sp-node{width:46px;height:46px;border-radius:14px;}',
        '.ev-sp-chip{margin-bottom:9px;}',
        '.ev-sp-boot{margin-bottom:11px;font-size:.72rem;}',
        '.ev-sp-rows{gap:5px;}',
        '.ev-sp-row{padding:7px 12px;gap:10px;}',
        '.ev-sp-tx b{font-size:.8rem;}.ev-sp-tx i{font-size:.67rem;}',
        '.ev-sp-batt{margin-top:11px;}',
      '}',
